...
// DarkVeil - CPPN neural-network organic shader
// Tuned for charcoal: hue shift zeroed, warp subtle, no scanlines
...
export default function Shader5DarkVeil() {
